...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/sys/user/edit"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-8 data">
							<input type="text" class="form-control" name="username"
								   placeholder="用户名称" value="${sysUser.username}">
						</div>
						...
						<div class="col-md-8 data">
							<select class="form-control select2" style="width: 100%"
									name="usersex">
								<c:if test="${sysUser.usersex == '1'}">
									<option value="1" selected="selected">男</option>
									<option value="0" >女</option>
								</c:if>
								<c:if test="${sysUser.usersex == '0'}">
						...
						<div class="col-md-8 data">
							<select class="form-control select2" style="width: 100%"
									name="userstate">
								<c:if test="${sysUser.userstate=='1'}">
									<option value="1" selected="selected">可用</option>
									<option value="0">不可用</option>
								</c:if>
								<c:if test="${sysUser.userstate=='0'}">
						...
						<div class="col-md-4 title">选择角色</div>
						<input type="hidden" id="data-roleid" value="${sysUser.roleid}">
						<div class="col-md-8 data">
							<select class="form-control select2" style="width: 100%"
									name="roleid" id="role">
	...
	<script>
		$(function () {
		    var roleid = $("#data-roleid").val();
		    //alert(roleid);
		    $.post("${pageContext.request.contextPath}/sys/role/getAll",{},function (data) {
                $("#role").html();
