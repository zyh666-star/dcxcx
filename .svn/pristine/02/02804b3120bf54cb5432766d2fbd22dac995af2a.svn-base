	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form class="form-horizontal"
				action="${pageContext.request.contextPath}/web/goodstype/edit"
				method="post">
				<!-- 正文区域 -->
				<section class="content"> <!--产品信息--> <input type="hidden"
					value="${goodstype.gtid}" name="gtid">
				<div class="panel panel-default">
					<div class="row data-type">
						<div class="col-md-4 title">菜品类型名称</div>
						<div class="col-md-8 data">
							<input type="text" class="form-control" name="gtname"
								placeholder="菜品类型名称" value="${goodstype.gtname}">
						</div>

						<div class="col-md-4 title">状态</div>
						<div class="col-md-8 data">
							<select class="form-control select2" style="width: 100%"
								name="gtstate">
								<c:choose>
									<c:when test="${goodstype.gtstate==1}">
