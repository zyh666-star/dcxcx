                    ...
                    <div class="table-box">
                        ...
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table"
                                ...
                                <c:forEach items="${role.functions}" var="fun">

                                    <c:if test="${fun.funpid=='-1'}">
                                        <tr data-tt-id="${fun.funid}" data-tt-parent-id="0">
                                            <td colspan="2">${fun.funname}</td>
                                        </tr>

                                        <c:forEach items="${role.functions}" var="child">
