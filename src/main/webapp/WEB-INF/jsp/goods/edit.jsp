		...
		<div class="span12">
			<form class="form-horizontal form-inline"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="gname" type="text" name="gname" value="${goods.gname}"  />
				...
				<div class="control-group">
					...
					<div class="upload">
						<input type="text"  class="upload-url"  value="${goods.gimg}" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-group">
					      <input type="number" step="0.01" class="form-control" name="gprice" id="gprice" placeholder="￥0.00" value="${goods.gprice}" >
					    </div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="form-control" name="gcontent" rows="5" style="width:283px;resize:none"  
						>${goods.gcontent}</textarea>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-group">
					      <input type="number" step="0.01" class="form-control" name="gtime" id="gtime" placeholder="小时数（可精确到小数点后两位）" value="${goods.gtime}" >分钟
					    </div>
					</div>
				</div>
				<div class="control-group">
