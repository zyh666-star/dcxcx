				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-8 data">
							<input type="text" class="form-control" name="nowUsername"
								   placeholder="用户名称" value="${nowUsername}" readonly="readonly">
						</div>

						<div class="col-md-4 title">旧密码</div>
						<div class="col-md-8 data">
							<input type="password" class="form-control"
								   placeholder="旧密码" name="oldUserpwd">
						</div>
						...
						<div class="col-md-12 title" id="checkData"></div>
					</div>
				</div>
	...
	<script>
		$(function () {
		    ...
		    $("#twoUserpwd").blur(function () {
				...
				if($(this).val() != onepwd){
                    $("#twoUserpwd").css("border","red,solid,1px");
				    $("#checkData").css("color","red","font-size","15px");
				    $("#checkData").html("两次密码不一致!");
				}else{
				    $("#data-pwd").val(1);
                    $("#checkData").css("color","green","font-size","15px");
                    $("#checkData").html("√");
			...
			$("#saveEditPwdBtn").click(function () {
                $.post("${pageContext.request.contextPath}/sys/user/editPwd",$("#editpwdform").serialize(),function (data) {
                    if(data.editState==1){
                        alert("修改密码成功，请重新登录!");
                        location.href='${pageContext.request.contextPath}/sys/user/toLogin';
